...
clust_data$clusters_sat_area_cm2 <- factor(clust_data$clusters_sat_area_cm2,
                                           ...
                                           labels = c("low", "high"))
clust_data %>% 
  ggplot(aes(x=clusters_sat_area_cm2, y=muscle_area_cm2))+
  geom_boxplot()
...
clust_data$clusters_total_fat_area <- factor(clust_data$clusters_total_fat_area,
                                           ...
                                           labels = c("low", "high"))
clust_data %>% 
  ggplot(aes(x=clusters_total_fat_area, y=muscle_area_cm2))+
  geom_boxplot()

clust <- Mclust(clust_data$muscle_mean_hu, G = 2)
summary(clust)
...
clust_data$clusters_muscle_mean_hu <- factor(clust_data$clusters_muscle_mean_hu,
                                           ...
                                           labels = c("low", "high"))
clust_data %>% 
  ggplot(aes(x=clusters_muscle_mean_hu, y=muscle_area_cm2))+
  geom_boxplot()

clust <- Mclust(clust_data$imat_mean_hu, G = 2)
summary(clust)
...
clust_data$clusters_imat_mean_hu <- factor(clust_data$clusters_imat_mean_hu,
                                           ...
                                           labels = c("low", "high"))
clust_data %>% 
  ggplot(aes(x=clusters_imat_mean_hu, y=muscle_area_cm2))+
  geom_boxplot()
...
clust_data$clusters_muscle_hu_sd <- factor(clust_data$clusters_muscle_hu_sd,
                                           ...
                                           labels = c("low", "high"))
clust_data %>% 
  ggplot(aes(x=clusters_muscle_hu_sd, y=muscle_area_cm2))+
  geom_boxplot()
...
clust_data %>% 
  ggplot(aes(x=clusters_v_s_ratio, y=muscle_area_cm2))+
  geom_boxplot()
