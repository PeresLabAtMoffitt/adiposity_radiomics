...
data <- data %>%
  ...
  mutate(across(c(contains("tat_cm")), ~ . / (height_m ^2),
                .names = "{.col}_index"), .after = l3start_l3end_tat_cm3) %>%
...
```{r check proportion cm2 vs cm3}
# which(round(data$l3midavg_muscle_proportion_cm2, 3) != round(data$l3midavg_muscle_proportion_cm3, 3))
# which(round(data$l3midavg_vat_proportion_cm2, 3) != round(data$l3midavg_vat_proportion_cm3, 3))
# which(round(data$l3midavg_sat_proportion_cm2, 3) != round(data$l3midavg_sat_proportion_cm3, 3))
# which(round(data$l3midavg_imat_proportion_cm2, 3) != round(data$l3midavg_imat_proportion_cm3, 3))
# They are identical

# which(round(data$l3mid_vat_adipprop_cm2, 3) != round(data$l3mid_vat_adipprop_cm3, 3))
# which(round(data$l3mid_sat_adipprop_cm2, 3) != round(data$l3mid_sat_adipprop_cm3, 3))
# which(round(data$l3mid_imat_adipprop_cm2, 3) != round(data$l3mid_imat_adipprop_cm3, 3))
# They are identical
```
...
```{r save data}
write_csv(data, paste0(here::here(), 
                       "/data/processed_data/analysis_2",
                       "/clinical_dafs_moffitt_roswell_analysis_data_", 
...
```{r table by site}
tbl_midavg <- data %>%
  select(l3midavg_skm_hu_mean, l3midavg_myosteatosis,,
         l3midavg_skm_area_cm2, l3midavg_sat_area_cm2, l3midavg_vat_area_cm2, 
         l3midavg_imat_area_cm2, l3midavg_v_s_ratio_cm2, l3midavg_tat_cm2, 
         l3midavg_skm_volume_cm3, l3midavg_sat_volume_cm3, l3midavg_vat_volume_cm3, 
         l3midavg_imat_volume_cm3, l3midavg_v_s_ratio_cm3, l3midavg_tat_cm3,
         site) %>% 
...
tbl_mid <- data %>%
  select(l3mid_skm_hu_mean, l3mid_myosteatosis,
         l3mid_skm_area_cm2, l3mid_sat_area_cm2, l3mid_vat_area_cm2, 
         l3mid_imat_area_cm2,l3mid_v_s_ratio_cm2, l3mid_tat_cm2, 
         l3mid_skm_volume_cm3, l3mid_sat_volume_cm3, l3mid_vat_volume_cm3, 
         l3mid_imat_volume_cm3, l3mid_v_s_ratio_cm3, l3mid_tat_cm3,
         site) %>%
...
tbl_l3startend <- data %>%
  select(l3start_l3end_skm_hu_mean, l3start_l3end_myosteatosis,
         l3start_l3end_skm_area_cm2, l3start_l3end_sat_area_cm2, l3start_l3end_vat_area_cm2, 
         l3start_l3end_imat_area_cm2, l3start_l3end_v_s_ratio_cm2, l3start_l3end_tat_cm2, 
         l3start_l3end_skm_volume_cm3, l3start_l3end_sat_volume_cm3, l3start_l3end_vat_volume_cm3, 
         l3start_l3end_imat_volume_cm3, l3start_l3end_v_s_ratio_cm3, l3start_l3end_tat_cm3,
         site) %>%
...
```{r site index}
tbl_midavg <- data %>%
  select(l3midavg_smi, l3midavg_sarcopenia, l3midavg_sat_area_cm2_index, l3midavg_vat_area_cm2_index, 
         l3midavg_imat_area_cm2_index, l3midavg_tat_cm2_index, 
         l3midavg_skm_volume_cm3_index, l3midavg_sat_volume_cm3_index, l3midavg_vat_volume_cm3_index, 
         l3midavg_imat_volume_cm3_index, l3midavg_tat_cm3_index,
         site) %>% 
  `colnames<-`(str_remove(colnames(.), "l3midavg_") %>%
                 str_replace(., "smi", "SMI") %>%
...
tbl_mid <- data %>%
  select(l3mid_smi, l3mid_sarcopenia, l3mid_sat_area_cm2_index, l3mid_vat_area_cm2_index,
         l3mid_imat_area_cm2_index, l3mid_tat_cm2_index, 
         l3mid_skm_volume_cm3_index, l3mid_sat_volume_cm3_index, l3mid_vat_volume_cm3_index, 
         l3mid_imat_volume_cm3_index, l3mid_tat_cm3_index, 
         site) %>%
  `colnames<-`(str_remove(colnames(.), "l3mid_") %>%
                 str_replace(., "smi", "SMI") %>%
                 str_replace(., "sarcopenia", "Sarcopenia") %>%
...
tbl_l3startend <- data %>%
  select(l3start_l3end_smi, l3start_l3end_sarcopenia, l3start_l3end_sat_area_cm2_index, l3start_l3end_vat_area_cm2_index,
         l3start_l3end_imat_area_cm2_index, l3start_l3end_tat_cm2_index, 
         l3start_l3end_skm_volume_cm3_index, l3start_l3end_sat_volume_cm3_index, l3start_l3end_vat_volume_cm3_index,
         l3start_l3end_imat_volume_cm3_index, l3start_l3end_tat_cm3_index,
         site) %>%
  `colnames<-`(str_remove(colnames(.), "l3start_l3end_") %>%
                 str_replace(., "smi", "SMI") %>%
                 str_replace(., "sarcopenia", "Sarcopenia") %>%
...
```{r cat table by site}
tbl_midavg <- data %>%
  select(l3midavg_skm_hu_mean_tertcat,
         l3midavg_skm_area_cm2_tertcat, l3midavg_sat_area_cm2_tertcat, l3midavg_vat_area_cm2_tertcat, 
         l3midavg_imat_area_cm2_tertcat, l3midavg_v_s_ratio_cm2_tertcat, l3midavg_tat_cm2_tertcat, 
         l3midavg_skm_volume_cm3_tertcat, l3midavg_sat_volume_cm3_tertcat, l3midavg_vat_volume_cm3_tertcat, 
         l3midavg_imat_volume_cm3_tertcat, l3midavg_v_s_ratio_cm3_tertcat, l3midavg_tat_cm3_tertcat,
         site) %>%
  `colnames<-`(str_remove(colnames(.), "l3midavg_") %>%
...
tbl_mid <- data %>%
  select(l3mid_skm_hu_mean_tertcat,
         l3mid_skm_area_cm2_tertcat, l3mid_sat_area_cm2_tertcat, l3mid_vat_area_cm2_tertcat, 
         l3mid_imat_area_cm2_tertcat, l3mid_v_s_ratio_cm2_tertcat, l3mid_tat_cm2_tertcat, 
         l3mid_skm_volume_cm3_tertcat, l3mid_sat_volume_cm3_tertcat, l3mid_vat_volume_cm3_tertcat, 
         l3mid_imat_volume_cm3_tertcat, l3mid_v_s_ratio_cm3_tertcat, l3mid_tat_cm3_tertcat,
         site) %>%
  `colnames<-`(str_remove(colnames(.), "l3mid_") %>%
                 str_replace(., "tertcat", "(cat)") %>%
                 str_replace(., "v_s", "V/S") %>%
...
tbl_l3startend <- data %>%
  select(l3start_l3end_skm_hu_mean_tertcat,
         l3start_l3end_skm_area_cm2_tertcat, l3start_l3end_sat_area_cm2_tertcat, l3start_l3end_vat_area_cm2_tertcat,
         l3start_l3end_imat_area_cm2_tertcat, l3start_l3end_v_s_ratio_cm2_tertcat, l3start_l3end_tat_cm2_tertcat, 
         l3start_l3end_skm_volume_cm3_tertcat, l3start_l3end_sat_volume_cm3_tertcat, l3start_l3end_vat_volume_cm3_tertcat,
         l3start_l3end_imat_volume_cm3_tertcat, l3start_l3end_v_s_ratio_cm3_tertcat, l3start_l3end_tat_cm3_tertcat,
         site) %>%
  `colnames<-`(str_remove(colnames(.), "l3start_l3end_") %>%
                 str_replace(., "tertcat", "(cat)") %>%
                 str_replace(., "v_s", "V/S") %>%
...
```{r cat site index}
tbl_midavg <- data %>%
  select(l3midavg_smi_tertcat, l3midavg_sat_area_cm2_index_tertcat, l3midavg_vat_area_cm2_index_tertcat,
         l3midavg_imat_area_cm2_index_tertcat, l3midavg_tat_cm2_index_tertcat, 
         l3midavg_skm_volume_cm3_index_tertcat, l3midavg_sat_volume_cm3_index_tertcat, l3midavg_vat_volume_cm3_index_tertcat,
         l3midavg_imat_volume_cm3_index_tertcat, l3midavg_tat_cm3_index_tertcat,
         site) %>% 
  `colnames<-`(str_remove(colnames(.), "l3midavg_") %>%
                 str_replace(., "tertcat", "(cat)") %>%
                 str_replace(., "smi", "SMI") %>%
...
tbl_mid <- data %>%
  select(l3mid_smi_tertcat, l3mid_sat_area_cm2_index_tertcat, l3mid_vat_area_cm2_index_tertcat, 
         l3mid_imat_area_cm2_index_tertcat,l3mid_tat_cm2_index_tertcat, 
         l3mid_skm_volume_cm3_index_tertcat, l3mid_sat_volume_cm3_index_tertcat, l3mid_vat_volume_cm3_index_tertcat,
         l3mid_imat_volume_cm3_index_tertcat, l3mid_tat_cm3_index_tertcat,
         site) %>%
  `colnames<-`(str_remove(colnames(.), "l3mid_") %>%
                 str_replace(., "tertcat", "(cat)") %>%
                 str_replace(., "smi", "SMI") %>%
...
tbl_l3startend <- data %>%
  select(l3start_l3end_smi_tertcat, l3start_l3end_sat_area_cm2_index_tertcat, l3start_l3end_vat_area_cm2_index_tertcat,
         l3start_l3end_imat_area_cm2_index_tertcat, l3start_l3end_tat_cm2_index_tertcat,
         l3start_l3end_skm_volume_cm3_index_tertcat, l3start_l3end_sat_volume_cm3_index_tertcat, l3start_l3end_vat_volume_cm3_index_tertcat,
         l3start_l3end_imat_volume_cm3_index_tertcat, l3start_l3end_tat_cm3_index_tertcat,
         site) %>%
  `colnames<-`(str_remove(colnames(.), "l3start_l3end_") %>%
                 str_replace(., "tertcat", "(cat)") %>%
                 str_replace(., "smi", "SMI") %>%
...
midavg_data <- data %>%
  select(starts_with("l3midavg_") & contains("_ratio"),
         ...
         starts_with("l3midavg_") & contains("_adipprop"),
...
midavg_data %>%
  ...
  mutate(Feature = factor(Feature,
                          levels = c("vat_area_cm2_index", "sat_area_cm2_index", "imat_area_cm2_index",
                                     ...
                                     "vat_adipprop_cm2", "sat_adipprop_cm2", "imat_adipprop_cm2",
                                     "v_s_ratio_cm2", "tat_cm2", "tat_cm2_index", 
                                     "v_s_ratio_cm3", "tat_cm3", "tat_cm3_index", 
                                     "smi", "muscle_proportion_cm2", "skm_hu_mean", 
                                     "skm_volume_cm3_index"
                                     ))) %>%
...
ggcorrplot(midavg_mat, #hc.order = TRUE,
  ...
  geom_rect(aes(xmin = 27.6, xmax = 28.5, ymin = 0.5, ymax = 19.5), fill = "transparent", color = "orange")+
  geom_rect(aes(xmin = 19.5, xmax = 27.4, ymin = 0.5, ymax = 19.5), fill = "transparent", color = "orchid")+
  geom_rect(aes(xmin = 19.5, xmax = 27.4, ymin = 17.5, ymax = 18.5), fill = "transparent", color = "purple")+
...
tbl_sdhr <- tbl_uvregression(
  ...
  include = c("l3midavg_skm_hu_mean_sdhr", "l3midavg_myosteatosis",
              ...
              "l3midavg_tat_cm2_sdhr", "l3midavg_tat_cm3_sdhr"
              ),
  # pvalue_fun = label_style_pvalue(digits = 2)
  ) %>%
  bold_p(t = .05) %>%
...
tbl_index <- tbl_uvregression(
  ...
  include = c("l3midavg_smi_sdhr", "l3midavg_sarcopenia",
              ...
              "l3midavg_tat_cm2_index_sdhr", "l3midavg_tat_cm3_index_sdhr"
              ),
  # pvalue_fun = label_style_pvalue(digits = 2)
  ) %>%
  bold_p(t = .05) %>%
...
```{r gt UVA HR survival}
# merge_tbl <- 
  tbl_stack(list(tbl_uva1, tbl_sdhr, tbl_raw, tbl_index, tbl_prop, tbl_cat), 
...
# gt_tbl %>% 
#     tab_row_group(
#     label = "ALL categorical", rows = 92:204
#   ) %>% 
#     tab_row_group(
#     label = "1-SD normalized tissue proportion", rows = 78:91
#   ) %>% 
#     tab_row_group(
#     label = "1-SD normalized indexed features", rows = 67:77
#   ) %>% 
#     tab_row_group(
#     label = "Raw features", rows = 54:66
#   ) %>% 
#   tab_row_group(
...
## 1. HR MVA
### Clinical only
Age, stage, study site, and debulking status are associeted with survival.
```{r HR MVA}
tbl_2 <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage,
        data = data) %>%
...
tbl_merge(list(tbl_2, tbl_3),
                      tab_spanner = c("**Multivariable 1**", "**Debulking**"))



# print("PH assumption")
# coxph(Surv(time = data$os_time_from_dx_months,
#              event = data$os_event) ~ age_at_diagnosis + site + tnm_cs_mixed_group_stage + debulking,
#         data =  data)  %>%
#   cox.zph()
```
...
Poor muscle quality (low muscle HU or Myosteatosis) are associated with poor survival (trend for continuous muscle HU but significant association for the Myosteatosis category)
```{r}
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_skm_hu_mean_sdhr,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
tbl_deb <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + debulking + 
          l3midavg_skm_hu_mean_sdhr,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
tbl_1 <-
  tbl_merge(list(tbl_clin, tbl_deb), 
                    tab_spanner = c("**Multivariable 1**", "**Debulking**"))
...
tbl_stack(list(tbl_1, tbl_2),
                      group_header = c("Muscle quality", "Myosteatosis")) %>% 
  as_gt(rownames_to_stub = TRUE
  ) %>%
  gt::tab_options(row_group.border.top.color = "black",
                  row_group.border.top.width = 3,
...
### Multivariable for Muscle, VAT, SAT, IMAT, V/S, and TAT continuous per 1-SD 
There is a trend toward poorer survival for higher IMAT when additionally adjusted by debulking.   
In the "volume" section IMAT is significantly associated in both models.   
No associations for V/S ot TAT.
...
tbl_stack(list(tbl_1, tbl_2, tbl_3, tbl_4, tbl_5, tbl_6),
...
### Multivariable for height indexed Muscle, VAT, SAT, IMAT, V/S, and TAT continuous per 1-SD  
No association using the area features.   
The association with volume IMAT is significant for the height indexed feature in the non-debulking adjusted model.   
This association is attenuated in the debulking adjusted model.   
No associations for TAT.
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_vat_area_cm2_index_sdhr,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_sat_area_cm2_index_sdhr,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_stack(list(tbl_1, tbl_2, tbl_3, tbl_4, tbl_6),
                      group_header = c("Muscle", "VAT",
                                       "SAT", "IMAT", 
                                       "TAT")) %>% 
  as_gt(rownames_to_stub = TRUE
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_skm_volume_cm3_index_sdhr,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_vat_volume_cm3_index_sdhr,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_sat_volume_cm3_index_sdhr,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_imat_volume_cm3_index_sdhr,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
### Multivariable for proportion per 1-SD 
No association observed for the proportion and the adiposity proportion features.
```{r}
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_muscle_proportion_cm2_sdhr,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_vat_proportion_cm2_sdhr,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_sat_proportion_cm2_sdhr,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_imat_proportion_cm2_sdhr,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_stack(list(tbl_1, tbl_2, tbl_3, tbl_4),
                      group_header = c("Muscle", "VAT",
                                       "SAT", "IMAT")) %>% 
  as_gt(rownames_to_stub = TRUE
  ) %>%
...
### Multivariable for Adiposity proportion per 1-SD 
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_vat_adipprop_cm2_sdhr,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_imat_adipprop_cm2_sdhr,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_stack(list(tbl_2, tbl_3, tbl_4),
                      group_header = c("VAT",
                                       "SAT", "IMAT")) %>% 
  as_gt(rownames_to_stub = TRUE
  ) %>%
...
#### Multivariable for Muscle, VAT, SAT, IMAT, V/S, and TAT categorical
For area and volume features :   
Medium tertile category for SAT and IMAT show a better survival whereas High category have worse survival but the association are not significant (pvalue > 0.2).
Non-linear relationship (but not significant) for V/S and TAT in the debulking adjusted model... I am not sure if it is worth mentioning with these HR...?   

For volume feature for muscle mass :   
This is the only interesting result while looking at muscle mass. It shows a worse survival for the Medium and High categories of volume muscle mass.   
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_imat_area_cm2_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_v_s_ratio_cm2_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_skm_volume_cm3_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_vat_volume_cm3_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_sat_volume_cm3_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_imat_volume_cm3_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_v_s_ratio_cm3_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
#### Multivariable for height indexed Muscle, VAT, SAT, IMAT, and TAT categorical
Non-linear relationship (but not significant) for IMAT (area) and VAT, SAT, IMAT, and TAT (volume).
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_vat_area_cm2_index_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_sat_area_cm2_index_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_imat_area_cm2_index_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_tat_cm2_index_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_skm_volume_cm3_index_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_vat_volume_cm3_index_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_sat_volume_cm3_index_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_imat_volume_cm3_index_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_tat_cm3_index_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
Medium and High category for Muscle mass proportion shows a better survival. Seems that Muscle mass needs to be put in the context of other tissue proportion to be meaningful...   
Medium and High category for VAT proportion shows a better survival which is attenuated in the debulking adjusted model.   
Medium and High category for SAT and IMAT proportion shows a worse survival but not significant.   
```{r}
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_muscle_proportion_cm2_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_vat_proportion_cm2_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_sat_proportion_cm2_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_imat_proportion_cm2_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
#### Multivariable for Adiposity proportion
Comparing to the overall proportion results above, if looking at the adiposity proportion :   
VAT adiposity proportion association are even more attenuated.   
Medium and High category for SAT and IMAT proportion shows a worse survival but not significant (or trend).   
```{r}
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_vat_adipprop_cm2_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_sat_adipprop_cm2_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
tbl_clin <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
          tnm_cs_mixed_group_stage + 
          l3midavg_imat_adipprop_cm2_tertcat,
        data = data) %>%
  tbl_regression(exponentiate = TRUE) %>%
  bold_p(t = 0.05) %>%
  add_nevent(location = "level") %>% add_n(location = "level")
...
```
Multivariable for each phenotype
```{r}
tbl_1 <-
  coxph(Surv(time = data$os_time_from_dx_months,
             event = data$os_event) ~ age_at_diagnosis + site +
